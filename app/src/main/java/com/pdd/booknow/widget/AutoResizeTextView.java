...
public class AutoResizeTextView extends AppCompatTextView {
    ...
    /**
     * A dummy {@link AppCompatTextView} to test the text size without actually showing anything to the user
     */
    private AppCompatTextView mTestView;
    ...
    public AutoResizeTextView(Context context, AttributeSet attrs) {
        ...
        mTestView = new AppCompatTextView(context);
    ...
    /**
     * This method is guaranteed to be called by {@link AppCompatTextView#setText(CharSequence)} immediately.
     * Therefore we can safely add our modifications here and then have the parent class resume its
     * work. So if text has changed you should always call {@link AppCompatTextView#setText(CharSequence)} or
     * {@link AppCompatTextView#setText(CharSequence, BufferType)} if you know whether the {@link BufferType}
